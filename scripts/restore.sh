...
docker compose -f "$APP_DIR/docker-compose.prod.yml" stop web celery_worker celery_beat
...
docker compose -f "$APP_DIR/docker-compose.prod.yml" start web celery_worker celery_beat
